...
@RestController
@RequestMapping("/api/burger-11846-kafka")
public class Burger11846KafkaResource {

    private final Logger log = LoggerFactory.getLogger(Burger11846KafkaResource.class);

    private final KafkaProperties kafkaProperties;
    private KafkaProducer<String, String> producer;
    private ExecutorService sseExecutorService = Executors.newCachedThreadPool();

    public Burger11846KafkaResource(KafkaProperties kafkaProperties) {
