...
class Burger11846KafkaResourceIT {
    ...
    void setup() {
        ...
        Burger11846KafkaResource kafkaResource = new Burger11846KafkaResource(kafkaProperties);
    ...
    void producesMessages() throws Exception {
        restMockMvc.perform(post("/api/burger-11846-kafka/publish/topic-produce?message=value-produce"))
    ...
    void consumesMessages() throws Exception {
        ...
        MvcResult mvcResult = restMockMvc.perform(get("/api/burger-11846-kafka/consume?topic=topic-consume"))
            .andExpect(status().isOk())
